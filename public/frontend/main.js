...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (roomGalleryModal) {
        const galleryThumbnails = roomGalleryModal.querySelectorAll('.gallery-thumbnail');
    ...
    function initializeGalleryVideos() {
        const galleryVideos = document.querySelectorAll('.gallery-circle-wrapper video, .gallery-circle-image, .gallery-modal-image video, .gallery-rectangle-wrapper video, .instagram-circle-wrapper video');
                ...
                if (video.paused) {
                    ...
                    if (playPromise !== undefined) {
                        playPromise.then(() => {
                            ...
                            console.log('Gallery video autoplay prevented:', error);
                        });
                    }
                }
            };
    ...
    const galleryPhoneModalCarousel = document.getElementById('galleryPhoneModalCarousel');
    if (galleryPhoneModalCarousel) {
        galleryPhoneModalCarousel.addEventListener('slide.bs.carousel', function () {
            // Pause all videos first
            galleryPhoneModalCarousel.querySelectorAll('video').forEach(v => {
                v.pause();
                v.currentTime = 0;
            });
            ...
            // Play active video
            setTimeout(() => {
                const activeVideo = galleryPhoneModalCarousel.querySelector('.carousel-item.active video');
                if (activeVideo) {
    ...
    const galleryTabletCarousel = document.getElementById('galleryTabletCarousel');
    ...
    function initializeInstagramVideos() {
        const instagramVideos = document.querySelectorAll('.instagram-circle-wrapper video, .instagram-modal-image video');
                ...
                if (video.paused) {
                    ...
                    if (playPromise !== undefined) {
                        playPromise.then(() => {
                            ...
                            console.log('Instagram video autoplay prevented:', error);
                        });
                    }
                }
            };
    ...
    const instagramPhoneCarousel = document.getElementById('instagramPhoneCarousel');
    if (instagramPhoneCarousel) {
        instagramPhoneCarousel.addEventListener('slide.bs.carousel', function () {
            // Pause all videos first
            instagramPhoneCarousel.querySelectorAll('video').forEach(v => {
                v.pause();
                v.currentTime = 0;
            });
            ...
            // Play active video
            setTimeout(() => {
                const activeVideo = instagramPhoneCarousel.querySelector('.carousel-item.active video');
                if (activeVideo) {
                    activeVideo.play().catch(error => {
                        console.log('Instagram modal video autoplay prevented:', error);
                    });
                }
            }, 300);
        });
