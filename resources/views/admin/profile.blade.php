...
.admin-profile-btn .profile-btn-loader { display: none; }
.admin-profile-btn.loading .btn-text,
.admin-profile-btn.loading .profile-btn-text { display: none; }
.admin-profile-btn.loading .btn-loader,
.admin-profile-btn.loading .profile-btn-loader { display: inline-flex !important; align-items: center; gap: 0.35rem; }
.admin-profile-btn:disabled { opacity: 0.7; cursor: not-allowed; pointer-events: none; }
</style>
@endpush
            ...
            <div class="card-body">
                    ...
                    <div id="viewTab" class="admin-profile-tab-content active">
                        <form id="profileForm">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="admin-profile-form-group">
                                        <label class="admin-profile-form-label">Name <span class="text-muted" style="font-size: 0.8rem;">(Optional)</span></label>
                                        <input type="text" class="admin-profile-form-input" id="adminName" name="admin_name" value="{{ $adminSettings->admin_name ?? session('admin_username') ?? '' }}" placeholder="Enter your name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-profile-form-group">
                                        <label class="admin-profile-form-label">Email Address <span class="text-muted" style="font-size: 0.8rem;">(Optional)</span></label>
                                        <input type="email" class="admin-profile-form-input" id="adminEmail" name="admin_email" value="{{ $adminSettings->admin_email ?? session('admin_email') ?? '' }}" placeholder="Enter your email">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="admin-profile-form-group">
                                        ...
                                        <input type="email" class="admin-profile-form-input" id="adminEmail1" name="admin_email_1" value="{{ $adminSettings->admin_email_1 ?? '' }}" placeholder="Main email">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-profile-form-group">
                                        <label class="admin-profile-form-label">Second Email <span class="text-muted" style="font-size: 0.8rem;">(Optional)</span></label>
                                        <input type="email" class="admin-profile-form-input" id="adminEmail2" name="admin_email_2" value="{{ $adminSettings->admin_email_2 ?? '' }}" placeholder="Second email">
                                    </div>
                                </div>
                            </div>

                            @php
                                $hasAnyNumber = !empty($adminSettings->admin_number_1 ?? '') || !empty($adminSettings->admin_number_2 ?? '');
                            @endphp
                            <div class="row">
                                <div class="col-12">
                                    @if(!$hasAnyNumber)
                                    <div class="admin-profile-info-card mb-3" style="background: rgba(255, 161, 0, 0.08); border: 1px dashed #ffa100;">
                                        <div class="d-flex align-items-center gap-2 mb-0">
                                            <i class="fas fa-phone-alt text-warning"></i>
                                            <span class="admin-profile-info-value mb-0">No contact numbers added yet. Add your main number below to use OTP for forget password.</span>
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-profile-form-group">
                                        ...
                                        <input type="text" class="admin-profile-form-input" id="adminNumber1" name="admin_number_1" value="{{ $adminSettings->admin_number_1 ?? '' }}" placeholder="{{ $hasAnyNumber ? 'Main phone number' : 'Add main phone number (OTP will go here)' }}">
                                        @if(!$hasAnyNumber)
                                ...
                                <div class="col-md-6">
                                    <div class="admin-profile-form-group">
                                        <label class="admin-profile-form-label">Second Number <span class="text-muted" style="font-size: 0.8rem;">(Optional)</span></label>
                                        <input type="text" class="admin-profile-form-input" id="adminNumber2" name="admin_number_2" value="{{ $adminSettings->admin_number_2 ?? '' }}" placeholder="{{ $hasAnyNumber ? 'Second phone number' : 'Add second phone number' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="admin-profile-info-card">
                                ...
                                <div class="admin-profile-info-value">{{ session('admin_login_time') ? \Carbon\Carbon::parse(session('admin_login_time'))->format('d M Y, h:i A') : 'N/A' }}</div>
                            </div>
                            ...
                            <div class="admin-profile-form-group">
                                <button type="button" id="btnUpdateProfile" class="admin-profile-btn admin-profile-btn-primary" onclick="updateProfile()">
                                    <span class="btn-text"><i class="fas fa-save"></i> <span>Update Profile</span></span>
                                    <span class="btn-loader" style="display:none;"><span class="spinner-border spinner-border-sm me-2" role="status"></span> Updating...</span>
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="passwordTab" class="admin-profile-tab-content">
                        <form id="passwordForm">
                            @csrf
                            <div class="admin-profile-form-group">
                                <label class="admin-profile-form-label">Current Password <span class="required">*</span></label>
                                <input type="password" class="admin-profile-form-input" id="currentPassword" name="current_password" placeholder="Enter current password" required>
                            </div>
                            <div class="admin-profile-form-group">
                                <label class="admin-profile-form-label">New Password <span class="required">*</span></label>
                                <input type="password" class="admin-profile-form-input" id="newPassword" name="new_password" placeholder="Enter new password" required>
                                <small class="text-muted">Minimum 6 characters</small>
                            </div>
                            <div class="admin-profile-form-group">
                                <label class="admin-profile-form-label">Confirm New Password <span class="required">*</span></label>
                                <input type="password" class="admin-profile-form-input" id="confirmPassword" name="confirm_password" placeholder="Confirm new password" required>
                            </div>
                            <div class="admin-profile-form-group">
                                <button type="button" id="btnChangePassword" class="admin-profile-btn admin-profile-btn-primary" onclick="updatePassword()">
                                    <span class="btn-text"><i class="fas fa-key"></i> <span>Change Password</span></span>
                                    <span class="btn-loader" style="display:none;"><span class="spinner-border spinner-border-sm me-2" role="status"></span> Updating...</span>
                                </button>
                            </div>
                        </form>
                        ...
                        <div class="mt-4 pt-4 border-top">
                            ...
                            <p class="text-muted mb-3">If you've forgotten your password, you can reset it using OTP verification sent to your main phone number.</p>
                            <button type="button" class="admin-profile-btn admin-profile-btn-secondary" onclick="openForgotPasswordModal()">
...
<div id="otpModalOverlay" class="admin-otp-modal-overlay" onclick="closeOtpModal()">
    <div class="admin-otp-modal" onclick="event.stopPropagation()">
        ...
        <div id="otpStep1" class="admin-otp-form-step active">
            ...
            <div class="admin-profile-info-card mb-3" style="background: rgba(255, 161, 0, 0.08); border: 1px dashed #ffa100;">
                <div class="admin-profile-info-value mb-0" style="font-size: 0.95rem;">Add your main phone number in <strong>View Profile</strong> first. OTP will be sent to that number.</div>
            </div>
            @endif
            <div class="admin-profile-form-group">
                <label class="admin-profile-form-label">Enter Your Main Phone Number <span class="required">*</span></label>
                <input type="text" class="admin-profile-form-input" id="otpPhoneNumber" placeholder="+91 1234567890" value="{{ $adminSettings->admin_number_1 ?? '' }}">
                <small class="text-muted">Enter the same number you added in Profile. OTP will be sent to this number.</small>
            </div>
            <div class="admin-profile-form-group">
                <button type="button" id="btnSendOtp" class="admin-profile-btn admin-profile-btn-primary w-100" onclick="sendOTP()" @if(empty($adminSettings->admin_number_1)) title="Add main number in View Profile first" @endif>
                    <span class="btn-text"><i class="fas fa-paper-plane"></i> <span>Send OTP</span></span>
                    <span class="btn-loader" style="display:none;"><span class="spinner-border spinner-border-sm me-2" role="status"></span> Sending...</span>
                </button>
            </div>
        </div>
        ...
        <div id="otpStep2" class="admin-otp-form-step">
            <div class="admin-profile-form-group">
                ...
                <input type="text" class="admin-profile-form-input" id="otpCode" placeholder="Enter 6-digit OTP" maxlength="6">
            ...
            <div class="admin-profile-form-group">
                <button type="button" id="btnVerifyOtp" class="admin-profile-btn admin-profile-btn-primary w-100" onclick="verifyOTP()">
                    <span class="btn-text"><i class="fas fa-check"></i> <span>Verify OTP</span></span>
                    <span class="btn-loader" style="display:none;"><span class="spinner-border spinner-border-sm me-2" role="status"></span> Verifying...</span>
                </button>
            </div>
        ...
        <div id="otpStep3" class="admin-otp-form-step">
            <div class="admin-profile-form-group">
                <label class="admin-profile-form-label">New Password <span class="required">*</span></label>
                <input type="password" class="admin-profile-form-input" id="resetPassword" placeholder="Enter new password" required>
                <small class="text-muted">Minimum 6 characters</small>
            </div>
            <div class="admin-profile-form-group">
                <label class="admin-profile-form-label">Confirm New Password <span class="required">*</span></label>
                <input type="password" class="admin-profile-form-input" id="resetConfirmPassword" placeholder="Confirm new password" required>
            </div>
            <div class="admin-profile-form-group">
                <button type="button" id="btnResetPassword" class="admin-profile-btn admin-profile-btn-primary w-100" onclick="resetPassword()">
                    <span class="btn-text"><i class="fas fa-save"></i> <span>Reset Password</span></span>
                    <span class="btn-loader" style="display:none;"><span class="spinner-border spinner-border-sm me-2" role="status"></span> Resetting...</span>
                </button>
            </div>
        </div>
    </div>
...
function updateProfile() {
    ...
    .then(result => {
        ...
        if (result.success) {
            ...
            const errorMsg = result.errors ? Object.values(result.errors).flat().join(', ') : (result.message || 'Error updating profile');
...
function updatePassword() {
    ...
    const data = { current_password: currentPassword, admin_password: newPassword };
    fetch('/admin/profile', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
    ...
    .then(result => {
        ...
        if (result.success) {
            ...
            const errorMsg = result.errors ? Object.values(result.errors).flat().join(', ') : (result.message || 'Error updating password');
            if (typeof window.toast === 'function') window.toast('error', errorMsg);
            else alert(errorMsg);
        }
    })
...
function verifyOTP() {
    ...
    .then(result => {
        setProfileBtnLoading('btnVerifyOtp', false);
        if (result.success) {
            if (typeof window.toast === 'function') window.toast('success', result.message || 'OTP verified successfully!');
...
function resetPassword() {
    ...
    .then(result => {
        ...
        if (result.success) {
            if (typeof window.toast === 'function') window.toast('success', result.message || 'Password reset successfully!');
            else alert(result.message || 'Password reset successfully!');
            setTimeout(() => { closeOtpModal(); window.location.href = '/login/hotelkiranpalace/admin'; }, 1500);
        } else {
