...
<header class="admin-header">
    <div class="admin-header-content">
        ...
        <div class="admin-header-actions">
            ...
            <!-- View Website Link -->
            <a href="{{ route('home') }}" target="_blank" class="admin-header-link d-none d-md-inline-flex"
                title="View Website">
            ...
            <div class="dropdown admin-profile-dropdown">
                <button class="admin-profile-btn" type="button" id="adminProfileDropdown" data-bs-toggle="dropdown"
                    aria-expanded="false">
