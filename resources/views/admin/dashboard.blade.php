                ...
                <table class="admin-dashboard-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>
                                <a href="mailto:{{ $user->email }}" class="admin-gallery-table-email-link" title="{{ $user->email }}">
                                    {{ $user->email }}
                                </a>
                            </td>
                            ...
                            <td>
                                @php
                                    ...
                                    if ($daysPassed <= 0) {
                                        ...
                                        $statusText = (int)$daysPassed . ' day' . ($daysPassed > 1 ? 's' : '') . ' ago';
                                    }
                                @endphp
                ...
                <table class="admin-dashboard-table">
                    ...
                    <tbody>
                        ...
                        @php
                            ...
                            $roomTypeDisplay = $submission->room_type ? ($roomTypes[$submission->room_type] ?? ucfirst($submission->room_type)) : 'N/A';
                        @endphp
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $submission->name }}</td>
                            <td>
                                <a href="mailto:{{ $submission->email }}" class="admin-gallery-table-email-link" title="{{ $submission->email }}">
                                    {{ $submission->email }}
                                </a>
                            </td>
