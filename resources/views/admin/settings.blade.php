        ...
        <form id="settingsForm">
            ...
            <div class="admin-settings-staff-group">
                <div class="admin-settings-form-group">
                    ...
                    <input type="email" class="admin-settings-form-input" id="staffEmail1" name="staff_email_1" value="{{ $settings->staff_email_1 ?? '' }}" placeholder="staff1@example.com">
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Staff Email 2</label>
                    <input type="email" class="admin-settings-form-input" id="staffEmail2" name="staff_email_2" value="{{ $settings->staff_email_2 ?? '' }}" placeholder="staff2@example.com">
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Staff Email 3</label>
                    <input type="email" class="admin-settings-form-input" id="staffEmail3" name="staff_email_3" value="{{ $settings->staff_email_3 ?? '' }}" placeholder="staff3@example.com">
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Staff Number 1</label>
                    <input type="text" class="admin-settings-form-input" id="staffNumber1" name="staff_number_1" value="{{ $settings->staff_number_1 ?? '' }}" placeholder="+91 1234567890">
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Staff Number 2</label>
                    <input type="text" class="admin-settings-form-input" id="staffNumber2" name="staff_number_2" value="{{ $settings->staff_number_2 ?? '' }}" placeholder="+91 1234567890">
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Staff Number 3</label>
                    <input type="text" class="admin-settings-form-input" id="staffNumber3" name="staff_number_3" value="{{ $settings->staff_number_3 ?? '' }}" placeholder="+91 1234567890">
                </div>
            </div>
            ...
            <p style="font-size: 0.85rem; color: #666; margin-bottom: 1rem;">
                <i class="fas fa-info-circle me-1"></i> At least 1 email and 1 number are required. You can add up to 2 emails and 2 numbers.
            </p>
            <div class="admin-settings-admin-group">
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Admin Email 1 <span style="color: #dc3545;">*</span></label>
                    <input type="email" class="admin-settings-form-input" id="adminEmail1" name="admin_email_1" value="{{ $settings->admin_email_1 ?? '' }}" placeholder="admin1@example.com" required>
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Admin Email 2 <span style="color: #999; font-size: 0.8rem;">(Optional)</span></label>
                    <input type="email" class="admin-settings-form-input" id="adminEmail2" name="admin_email_2" value="{{ $settings->admin_email_2 ?? '' }}" placeholder="admin2@example.com">
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Admin Number 1 <span style="color: #dc3545;">*</span></label>
                    <input type="text" class="admin-settings-form-input" id="adminNumber1" name="admin_number_1" value="{{ $settings->admin_number_1 ?? '' }}" placeholder="+91 1234567890" required>
                </div>
                <div class="admin-settings-form-group">
                    <label class="admin-settings-form-label">Admin Number 2 <span style="color: #999; font-size: 0.8rem;">(Optional)</span></label>
                    <input type="text" class="admin-settings-form-input" id="adminNumber2" name="admin_number_2" value="{{ $settings->admin_number_2 ?? '' }}" placeholder="+91 1234567890">
                </div>
            </div>
            ...
            <div class="admin-settings-form-group">
                ...
                <textarea class="admin-settings-form-textarea" id="address" name="address" placeholder="Enter full address">{{ $settings->address ?? '' }}</textarea>
            </div>
        </form>
    </div>
    <div class="admin-settings-panel-footer">
        <button type="button" class="admin-settings-btn admin-settings-btn-secondary" onclick="closeSettingsPanel()">Cancel</button>
        <button type="button" class="admin-settings-btn admin-settings-btn-primary" onclick="saveSetting()">Save Settings</button>
    </div>
</div>
@endsection
...
function saveSetting() {
    ...
    .then(result => {
        if (result.success) {
            ...
            const errorMsg = result.errors ? Object.values(result.errors).flat().join(', ') : (result.message || 'Error saving settings');
            if (typeof window.toast === 'function') {
