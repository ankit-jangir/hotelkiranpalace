                                            ...
                                            <td>
                                                @if ($room->main_image)
                                                    <img src="{{ asset('storage/' . $room->main_image) }}"
                                                        alt="{{ $room->title }}" class="admin-rooms-thumbnail"
            ...
            <form id="roomForm" enctype="multipart/form-data">
                ...
                <div class="admin-rooms-form-row">
                    <div class="admin-rooms-form-group">
                        ...
                        <input type="number" name="price" id="room_price" class="admin-rooms-form-input"
                            placeholder="0.00" step="0.01" min="0" required>
                    </div>
                    <div class="admin-rooms-form-group">
                        <label class="admin-rooms-form-label">Discount Price</label>
                        <input type="number" name="discount_price" id="room_discount_price"
                            class="admin-rooms-form-input" placeholder="0.00" step="0.01" min="0">
                    </div>
                </div>
                ...
                <div class="admin-rooms-form-row">
                    ...
                    <div class="admin-rooms-form-group">
                        ...
                        <input type="number" name="available_rooms" id="room_available_rooms"
                            class="admin-rooms-form-input" placeholder="0" min="0" required>
                    </div>
                </div>
                ...
                <div class="admin-rooms-form-group">
                    ...
                    <div class="admin-rooms-image-preview-wrapper">
                        <input type="file" name="main_image" id="main_image" class="admin-rooms-form-input"
                            accept="image/*" onchange="previewMainRoomImage(this)">
                ...
                <div class="admin-rooms-form-group">
                    ...
                    <div id="roomFacilitiesContainer">
                        <div class="admin-rooms-facility-item">
                            ...
                            <button type="button" class="admin-rooms-remove-facility-btn"
                                onclick="removeRoomFacility(this)" style="display: none;">
                                <i class="fas fa-times"></i>
                            </button>
                        </div>
                    </div>
