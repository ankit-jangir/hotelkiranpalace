...
'contact' => [
'title' => 'Contact us',
'description' => "At Hotel Kiran Place, we're all about crafting moments that you'll cherish forever. If there's
anything we can do to make your stay even better, don't hesitate to share your thoughts with us.",
'breadcrumb' => 'Contact Us'
],
'about' => [
'title' => 'About Us',
'description' => 'Discover the story behind Hotel Kiran Place and our commitment to providing exceptional hospitality
and unforgettable experiences.',
'breadcrumb' => 'About Us'
],
'rooms' => [
'title' => 'Rooms & Tariff',
'description' => 'Experience luxury and comfort in our beautifully designed rooms, each thoughtfully crafted to ensure
your perfect stay.',
'breadcrumb' => 'Rooms & Tariff'
],
'amenities' => [
'title' => 'Amenities',
'description' => 'Explore our world-class facilities and amenities designed to enhance your stay and create memorable
experiences.',
            ...
            <div class="col-12">
                <div class="page-breadcrumb-wrapper">
                    ...
                    <div class="page-share">
                        <a href="#" class="share-link" data-bs-toggle="modal" data-bs-target="#shareModal"
            ...
            <div class="modal-body share-modal-body">
                ...
                <div class="share-link-preview">
                    <div class="share-preview-image">
                        <img src="{{ asset('images/heroimg1.jpg') }}" alt="Hotel Kiran Place"
                            onerror="this.onerror=null; this.src='{{ asset('images/hero_section_img1.png') }}';">
                    </div>
                ...
                <div class="share-social-section">
                    ...
                    <div class="share-social-icons">
                        <a href="#" class="share-social-icon share-facebook"
                            onclick="shareOnFacebook(event); return false;" title="Share on Facebook">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="#" class="share-social-icon share-twitter"
                            onclick="shareOnTwitter(event); return false;" title="Share on Twitter">
                            <i class="fab fa-x-twitter"></i>
                        </a>
                        <a href="#" class="share-social-icon share-instagram"
                            onclick="shareOnInstagram(event); return false;" title="Share on Instagram">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a href="#" class="share-social-icon share-email" onclick="shareViaEmail(event); return false;"
                            title="Share via Email">
                            <i class="fas fa-envelope"></i>
                        </a>
                        <a href="#" class="share-social-icon share-whatsapp"
                            onclick="shareOnWhatsApp(event); return false;" title="Share on WhatsApp">
                ...
                <div class="share-copy-section">
                    ...
                    <div class="share-copy-wrapper">
                        <input type="text" class="share-copy-input" id="shareLinkInput" value="{{ url()->current() }}"
                            readonly>
