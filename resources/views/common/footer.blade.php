    ...
    <div class="container">
        <div class="row mb-4 g-3 g-md-4">
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                ...
                <p class="footer-description mb-4">Experience the pinnacle of luxury and hospitality in the heart of
                    India. Where royal heritage meets modern elegance.</p>
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                ...
                <div class="footer-social">
                    ...
                    <a href="mailto:reservations@kiranpalace.com" class="social-icon"><i
        ...
        <div class="footer-bottom pt-3 border-top">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-md-end">
                    <p class="mb-0">Designed by <a href="#"
                            class="footer-brand-name-link footer-brand-name">abxtechnology</a></p>
                </div>
            </div>
        </div>
    </div>
...
<button id="scrollToTop" class="scroll-to-top" aria-label="Scroll to top">
    ...
    <svg class="progress-ring" width="60" height="60" viewBox="0 0 60 60">
        <circle class="progress-ring-circle" cx="30" cy="30" r="27" fill="transparent"
            stroke="rgb(247, 71, 15)" stroke-width="3"></circle>
    </svg>
</button>
